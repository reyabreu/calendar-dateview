...
/**
 * This model is a "facade" for the JTable, JSpinner and Date models allowing
...
class DateViewModelHelper implements TableModel, ChangeListener,
    ...
    /**
     * The constructor takes an instance of the DateView, form which the actual
     * Date model used can be obtained.
     *
     * @param dateView
     * @param model
     */
    ...
    /**
     * Updates table and spinner model listeners on Date model changes
     */
     ...
     * (non-Javadoc)
     *
     * @see javax.swing.table.TableModel#removeTableModelListener(javax.swing
